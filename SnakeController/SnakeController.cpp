...
Ports::Ports(IPort& _displayPort, IPort& _foodPort, IPort& _scorePort)
    :m_displayPort(_displayPort),
     m_foodPort(_foodPort),
     m_scorePort(_scorePort)
{}


Controller::Controller(IPort& p_displayPort, IPort& p_foodPort, IPort& p_scorePort, std::string const& p_config)
    : m_gamePorts(p_displayPort, p_foodPort, p_scorePort),
      m_paused(false)
{
    ...
    if (w == 'W' and f == 'F' and s == 'S') {
        m_gameMap.m_mapDimension = std::make_pair(width, height);
        m_gameMap.m_foodPosition = std::make_pair(foodX, foodY);
...
void Map::sendPlaceNewFood(int x, int y)
{
...
Body::Segment Body::calculateNewHead(Direction m_currentDirection) const
{
...
void Body::removeTailSegment(IPort& m_displayPort)
{
...
void Body::addHeadSegment(Segment const& newHead, IPort& m_displayPort)
{
...
void Body::removeTailSegmentIfNotScored(Segment const& newHead)
{
...
void Body::updateSegmentsIfSuccessfullMove(Segment const& newHead)
{
...
void Map::updateFoodPosition(int x, int y, std::function<void()> clearPolicy)
{
